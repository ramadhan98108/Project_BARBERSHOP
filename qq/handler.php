...
if (isset($_GET['action'])) {
	...
	if ($action=="tambah_kasir") {
		$root->tambah_kasir($_POST['nama_kasir'],$_POST['password'],$_POST['id_lokasi'],$_POST['nama']);
	}
	if ($action=="hapus_user") {
		$root->hapus_user($_GET['id_user']);
	}
	if ($action=="edit_kasir") {
		$root->aksi_edit_kasir($_POST['nama'],$_POST['nama_kasir'],$_POST['password'],$_POST['id']);
	}
	if ($action=="edit_akun") {
		$root->aksi_edit_akun($_POST['nama'],$_POST['nama_kasir'],$_POST['password'],$_POST['id']);
	}
	if ($action=="edit_admin") {
		$root->aksi_edit_admin($_POST['nama'],$_POST['username'],$_POST['password']);
	}
	...
	$root->owner_tambah_kasir($_POST['nama'],$_POST['nama_kasir'],$_POST['password'],$_POST['status'],$_POST['id_lokasi']);
	}
	if ($action=="owner_edit_kasir") {
		$root->owner_aksi_edit_kasir($_POST['nama'],$_POST['nama_kasir'],$_POST['password'],$_POST['alamat'],$_POST['keterangan'],$_POST['id']);
	}
	...
	if ($action=="hapus_tempo") {
		$root->hapus_tempo($_GET['id_tempo'],$_GET['id_paket'],$_GET['jumbel']);
	}
